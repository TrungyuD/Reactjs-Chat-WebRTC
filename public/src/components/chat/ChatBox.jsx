  ...
  render: function () {
    ...
    return (
      <div className="chat-box" ref="root">
        <div className="chat-header ui-widget-header bg-dark">React p2p Chat</div>
        <div className="chat-content-wrapper row">
          <MessagesList ref="messagesList" user={this.state.users} username={this.props.username}></MessagesList>
